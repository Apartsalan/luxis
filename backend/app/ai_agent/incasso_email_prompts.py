...
STEP_SPECIFIC_GUIDANCE: dict[str, str] = {
    ...
    "Verweer beantwoorden": (
        ...
        "een abonnementsvordering te onderbouwen. Noemt de debiteur ZÉLF 'uren' of een "
        "'declaratie' terwijl de vordering een abonnement is? Corrigeer dan de premisse "
        "expliciet ('er worden geen uren gedeclareerd; het betreft een vast "
        "abonnementstarief voor de overeengekomen periode') in plaats van een "
        "declaratie-/uren-bepaling (zoals een '30-dagen declaratie betwisten'-artikel) "
        "aan te halen — dat zou de onjuiste premisse juist bevestigen.\n"
