# Roadmap-archief — Luxis

> Afgeronde/achterhaalde secties, verbatim verplaatst uit `LUXIS-ROADMAP.md` op 9 juli 2026.
> Status-markeringen per item zijn de stand van dat moment. Het enige open punt
> (AI Factuur Parsing Validatie, uit "Volgorde van werken") is overgenomen in de Backlog van de roadmap.

## Oude "Vorige:"-kopregels uit de roadmap-intro (verbatim)
...
## Prioriteit-blokken S254 t/m S251 (gearchiveerd 7 september 2026, S256)
