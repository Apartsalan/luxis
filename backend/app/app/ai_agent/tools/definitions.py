...
TOOL_DEFINITIONS: list[dict] = [
    # ── Cases (Dossiers) ─────────────────────────────────────────────────
    {
        "name": "case_list",
        "description": (
            "Zoek en filter dossiers. Kan filteren op type "
            "(incasso/insolventie/advies), status, cliënt, en "
            "vrije tekst. Geeft een gepagineerde lijst terug."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                ...
                "client_id": {
                    "type": "string",
                    "description": "UUID van de cliënt",
                },
                "is_active": {
                    "type": "boolean",
                    "default": True,
    ...
    },
    {
        "name": "case_get",
        "description": (
            "Haal alle details van één dossier op: type, status,"
            " cliënt, wederpartij, rentesoort, openstaand"
            " bedrag, etc."
        ),
        "input_schema": {
            "type": "object",
    ...
    },
    {
        "name": "case_create",
        "description": (
            "Maak een nieuw dossier aan. Vereist minimaal een"
            " cliënt-ID en openingsdatum. Genereert automatisch"
            " een zaaknummer."
        ),
        "input_schema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": (
            "Voeg een notitie of activiteit toe aan een dossier"
            " (bijv. telefoongesprek, email, notitie)."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    # ── Contacts (Relaties) ──────────────────────────────────────────────
    {
        "name": "contact_lookup",
        "description": (
            "Zoek bestaande relaties (personen of bedrijven)"
            " op naam, email, of KvK-nummer. Gebruik dit"
            " voordat je een nieuwe relatie aanmaakt om"
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "contact_id": {
                    "type": "string",
                    "description": "UUID van de relatie",
                },
            },
            "required": ["contact_id"],
        },
    ...
    },
    {
        "name": "claim_create",
        "description": (
            "Voeg een vordering toe aan een dossier. De"
            " verzuimdatum (default_date) is essentieel"
    ...
    },
    {
        ...
        "description": (
            "Registreer een betaling op een dossier. De"
            " betaling wordt automatisch verdeeld volgens"
            " art. 6:44 BW: eerst kosten, dan rente, dan"
            " hoofdsom."
        ),
        "input_schema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": (
            "Volledig financieel overzicht van een dossier:"
            " hoofdsom, rente (berekend per"
            " art. 6:119/6:119a BW), BIK (art. 6:96 BW),"
            " betalingen, en openstaand saldo. Dit is de"
            " kernberekening voor incasso."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    # ── Documents ────────────────────────────────────────────────────────
    {
        ...
        "description": (
            "Genereer een document vanuit een template voor"
            " een dossier (bijv. 14-dagenbrief, sommatie,"
            " renteoverzicht). Geeft het gegenereerde"
            " document terug."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                ...
                "template_id": {
                    "type": "string",
                    "description": "UUID van het template",
                },
                "title": {
                    "type": "string",
    ...
    # ── Invoices (Facturen) ──────────────────────────────────────────────
    {
        "name": "invoice_create",
        "description": (
            "Maak een nieuwe factuur aan (status: concept)."
            " Voeg daarna regels toe met invoice_add_line."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "invoice_id": {
                    "type": "string",
                    "description": "UUID van de factuur",
                },
                "description": {
                    "type": "string",
    ...
    },
    {
        ...
        "description": (
            "Debiteurenoverzicht: openstaande facturen"
            " gegroepeerd per relatie met aging buckets"
    ...
    # ── Pipeline (Incasso) ───────────────────────────────────────────────
    {
        ...
        "description": (
            "Overzicht van alle incasso-dossiers gegroepeerd"
            " per pipeline-stap"
            " (intake, herinnering, etc.)."
        ),
        "input_schema": {
            "type": "object",
            "properties": {},
    ...
    },
    {
        "name": "pipeline_batch",
        "description": (
            "Voer een batch-actie uit op meerdere dossiers"
            " tegelijk (bijv. verplaatsen naar volgende stap,"
            " documenten genereren, emails versturen)."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    # ── Workflow (Tasks) ─────────────────────────────────────────────────
    {
        "name": "task_create",
        "description": (
            "Maak een workflow-taak aan voor een dossier"
            " (bijv. check_payment, manual_review,"
            " send_letter)."
        ),
        "input_schema": {
            "type": "object",
    ...
    },
    {
        "name": "task_list",
        "description": (
            "Lijst openstaande workflow-taken. Kan filteren"
            " op dossier, status, of toegewezen gebruiker."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "Controleer alle actieve dossiers op naderende"
            " verjaring (art. 3:307 BW: 5 jaar). Geeft een"
            " lijst van dossiers die aandacht nodig hebben."
        ),
        "input_schema": {
            "type": "object",
            "properties": {},
    ...
    # ── General ──────────────────────────────────────────────────────────
    {
        ...
        "description": (
            "Dashboard KPI's: totaal dossiers, openstaande"
            " vorderingen, komende deadlines, recente"
            " activiteit."
        ),
        "input_schema": {
            "type": "object",
