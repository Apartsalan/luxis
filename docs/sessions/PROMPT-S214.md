...
Sessie 214 — KvK-rechtsvorm-backfill (zodra de echte sleutel binnen is)
...
(besluiten A–D) + SESSION-NOTES entry S213 (§Bekende issues).
...
- 206 vorderingen zonder gekoppelde factuur-PDF (S213: kostenposten / geen bestand / ander
  nummerschema) — handwerk-lijstje kan uit `scripts/link_invoice_files.py --dry-run`.
