...
**Laatst bijgewerkt:** 8 juli 2026 (sessie 183, Fable — **architectuur+security-audit, read-only. Oordeel livegang: JA, MITS.** Rapport + werkorder: `docs/research/audit-S183-architectuur-security.md`. Nieuw: S183-3 [HOOG] pro-rata-verdeling rekent fout bij creditfacturen (bewezen; 4 zaken in heropeningslijst), S183-1 [MIDDEN] `learned_answers` als enige tabel zonder RLS op prod, S183-2 [MIDDEN] RLS-rolwissel vervalt na tussentijdse commit (31 plekken, live bewezen), S183-4 [LAAG] betaling op/vóór verzuimdatum genegeerd in rente. Aantoonbaar op orde: rekenkernen+tests, auth/OAuth/uploads/secrets, S172-consolidatie AI-laag, scheduler. Next: `docs/sessions/PROMPT-S184.md` — Opus fix-sprint met het rapport als werkorder.)
