...
**Resterend uit audit:** H25 (modules_enabled) · #95 Fernet-key los van SECRET_KEY (vereist token-re-encrypt + deploy-coördinatie — alleen mét Arsalan) · BTW-op-rente (juridisch, samen met #54).
