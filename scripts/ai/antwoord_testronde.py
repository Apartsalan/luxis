...
_CORRECTOR_PROMPT = (
    ...
    "1. BEDRAGEN: het openstaande bedrag uit de dossiergegevens is leidend. Tel NOOIT "
    "zelf facturen op om het te controleren: op deels betaalde zaken is het openstaande "
    "bedrag veel lager dan de facturen, en met rente en kosten kan het juist hoger zijn. "
    "Een bedrag is alleen verzonnen als het NERGENS in de dossiergegevens of de "
    "mailwisseling voorkomt. Wijkt het antwoord af van een bedrag in een oudere mail in "
    "de thread, dan is het actuele dossierbedrag correct — niet afkeuren.\n"
    ...
    "dossier-/kenmerknummer dat in het onderwerp of de body van de inkomende mail staat, "
    "is een gegeven feit — nooit een verzinsel.\n"
