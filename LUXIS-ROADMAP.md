...
**Resterend (volgende sessie):** H25 (modules_enabled) · betaalbrieven-IBAN · BTW-op-rente · **~38 medium resterend** — verifieer elk tegen code (lijst bevat non-issues; 2 e2e email-router tests falen alleen lokaal door dev-Mailpit ≠ CI).
