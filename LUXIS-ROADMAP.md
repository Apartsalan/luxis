...
| C2 | Betalingstracking op facturen | Groot (nieuw DB model) | ✅ Backend gebouwd (InvoicePayment model, CRUD, overpayment guard, auto-status, 18 tests) — frontend nog niet |
