...
STEP_SPECIFIC_GUIDANCE: dict[str, str] = {
    ...
    "Verweer beantwoorden": (
        ...
        "voorbeeldreactie.\n"
        "HOUD HET SIMPEL — dit is het belangrijkste: verzin er GEEN extra argumenten "
        "bij, haal GEEN extra AV-artikelen aan, en beweer GEEN specifieke feiten (zoals "
        "een exacte periode, datums, of dat het een verlenging betreft) die je niet uit "
        "de stukken kunt afleiden. De voorbeeldreacties zijn bewust algemeen gehouden — "
        "laat dat zo. Voor een abonnement/serviceovereenkomst is de kern simpelweg: u "
        "bent een serviceovereenkomst aangegaan en er is niet betaald.\n"
