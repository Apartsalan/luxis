...
MERGE_FIELD_DEFINITIONS: dict[str, dict] = {
    ...
    "client": {
        ...
        "fields": [
            ...
            ("client.land", "Land (alleen buitenland)"),
    ...
    "wederpartij": {
        ...
        "fields": [
            ...
            ("wederpartij.land", "Land (alleen buitenland)"),
...
def _contact_ctx(contact: Contact | None) -> dict:
    ...
    return {
        ...
        # Land alleen bij niet-NL adressen; leeg = binnenland, niet tonen.
        "land": contact.visit_country or "",
