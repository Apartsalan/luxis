...
_REPLY_PROMPT = (
    ...
    "- BETAALBELOFTE (kalibratie 16-07): een concrete belofte op korte termijn mag je "
    "voor kennisgeving aannemen; verzoek betaling van het volledige bedrag uiterlijk op "
    "de genoemde datum en vraag tijdig bericht als dat niet lukt. Wek nooit de indruk "
    "dat de invordering intussen stilligt.\n"
