...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_trust_transactions_case_id"), "trust_transactions", ["case_id"], unique=False
    )
    op.create_index(
        op.f("ix_trust_transactions_tenant_id"), "trust_transactions", ["tenant_id"], unique=False
    )
