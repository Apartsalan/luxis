...
_REPLY_PROMPT = (
    ...
    "ontvangt.\n"
    "- Vraag de debiteur NOOIT om te wachten of niets te doen ('onderneem geen verdere "
    "actie tot u van ons hoort', 'wacht onze reactie af'). Dat leest als opschorting van "
    "de invordering en spreekt de rest van de brief tegen. Schrijf in plaats daarvan dat "
    "u zich nader zult berichten en dat de invordering intussen gewoon doorloopt (S230).\n"
