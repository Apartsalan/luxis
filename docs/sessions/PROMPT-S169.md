...
- **131 verweer-kandidaten** staan in "Slim leren" met status `kandidaat` — **ze voeden de AI nog NIET; Lisanne moet ze beoordelen.** Dat menselijke vangnet is nog niet geactiveerd.
