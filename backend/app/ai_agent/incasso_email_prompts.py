...
STEP_SPECIFIC_GUIDANCE: dict[str, str] = {
    ...
    "Verweer beantwoorden": (
        ...
        "STAP 3 — Gebruik de matchende voorbeeldreactie (STAP 2) als je weerlegging.\n"
        "Neem de body van de matchende voorbeeldreactie uit de verweer-bibliotheek "
        "grotendeels LETTERLIJK over als de weerlegging; pas 'm hooguit licht aan op de "
        "feiten. Begin met 1 korte zin die verwijst naar wat debiteur zei (bv. 'U heeft "
        "gesteld dat het abonnement is opgezegd.'), gevolgd door de tekst van de "
        "voorbeeldreactie.\n"
        "HOUD HET SIMPEL — dit is het belangrijkste: neem de voorbeeldreactie over zoals "
        "hij is. Verzin er GEEN extra argumenten bij, haal GEEN extra AV-artikelen aan, "
        "en vul GEEN specifieke datums of bedragen in die niet in de voorbeeldreactie "
        "staan. De voorbeeldreacties zijn de standaardtekst — gebruik die.\n"
        "HARDE REGEL: weerleg elk verweer ÉÉN keer; combineer niet meerdere alinea's "
        "over hetzelfde punt.\n\n"
        ...
        "het? Schrijf dan deze regel, met ÉÉN aanpassing: vervang het stuk tussen "
        "punthaken door de eigen woorden van de debiteur (samengevat, max 1 zin). De "
        "punthaken en de woorden 'kernverweer letterlijk uit incoming_defense' zijn een "
        "invul-aanwijzing en mogen NOOIT letterlijk in het concept blijven staan.\n"
        "  Mal:       [handmatig invullen door Lisanne: weerlegging van de stelling dat "
        "<kernverweer letterlijk uit incoming_defense>]\n"
        "  Debiteur schreef bv. 'de geleverde machine werkte niet' → schrijf:\n"
        "  Resultaat: [handmatig invullen door Lisanne: weerlegging van de stelling dat "
        "de geleverde machine niet werkte]\n"
        "Het kernverweer MOET de exacte bewoording van debiteur weergeven, geen "
        "generiek voorbeeld. Laat NOOIT de tekst 'incoming_defense' of 'kernverweer "
        "letterlijk' in het concept staan.\n\n"
