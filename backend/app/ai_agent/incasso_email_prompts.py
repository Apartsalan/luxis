...
STEP_SPECIFIC_GUIDANCE: dict[str, str] = {
    ...
    "Verweer beantwoorden": (
        ...
        "STAP 4 — ALLEEN bij echt geen match: placeholder.\n"
        "Geen enkele match betekent: het verweer past in geen van bovenstaande 5 "
        "categorieen. Pas dan: '[handmatig invullen door Lisanne: weerlegging van de "
        "stelling dat <kernverweer letterlijk uit incoming_defense>]'. Het kernverweer "
        "MOET de exacte bewoording van debiteur weergeven, geen generiek voorbeeld.\n\n"
        "STAP 5 — Rest van sjabloon: ONGEWIJZIGD.\n"
        "Aanhef, factuur-tabel, bedragen, afsluiting, ondertekening, disclaimer "
        "blijven exact zoals het sjabloon. Geen losse argumenten verzinnen."
    ),
}
