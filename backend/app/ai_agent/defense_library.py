...
kosten staat hiermee vast.""",
    ...
    DefenseExample(
        ...
        description=(
            ...
            "serviceovereenkomst. Standaardreactie: serviceovereenkomst "
            "voor één jaar met stilzwijgende verlenging; geen tijdige "
            "opzegging → automatisch verlengd → abonnementstarief "
            "verschuldigd."
        ),
        language="nl",
        relevant_categories=(
        ...
        body="""\
U heeft met cliënte een serviceovereenkomst gesloten voor de duur \
van één jaar, met stilzwijgende verlenging telkens voor de duur van \
een jaar, tenzij uiterlijk drie maanden voor het einde van de \
lopende termijn schriftelijk wordt opgezegd.

Cliënte heeft van u geen tijdige of geldige opzegging ontvangen. De \
overeenkomst is daarmee automatisch verlengd en loopt thans door. U \
bent om die reden gehouden tot betaling van het abonnementstarief \
