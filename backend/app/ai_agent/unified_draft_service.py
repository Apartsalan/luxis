...
_REPLY_PROMPT = (
    ...
    "je geeft aan ze aan de cliënt voor te leggen. Zeg er dan ALTIJD bij dat de "
    "betalingsverplichting en lopende termijnen onverkort blijven gelden totdat de "
    "debiteur schriftelijk anders bericht ontvangt — wek nooit de indruk dat de "
    "invordering intussen stilligt of dat betaling mag wachten op dat bericht.\n"
